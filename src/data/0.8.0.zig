...
//! `zig build gen -- --generate-version-data 0.8.0` (requires an internet connection)
...
pub const builtins = [_]Builtin{
    ...
    .{
        ...
        .documentation =
        \\Constructs a new [vector](https://ziglang.org/documentation/0.8.0/#Vectors) by selecting elements from `a` and `b` based on `mask`.
        \\
