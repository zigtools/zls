...
//! `zig build gen -- --generate-version-data 0.11.0` (requires an internet connection)
...
pub const builtins = [_]Builtin{
    ...
    .{
        ...
        \\This builtin can be called from a [comptime](https://ziglang.org/documentation/0.11.0/#comptime) block to conditionally export symbols. When
    ...
    .{
        ...
        .documentation =
        \\`). For unsigned integers, the result is [undefined](https://ziglang.org/documentation/0.11.0/#undefined) if any 1 bits are shifted out. For signed integers, the result is [undefined](https://ziglang.org/documentation/0.11.0/#undefined) if any bits that disagree with the resultant sign bit are shifted out.
        \\
    ...
    .{
        ...
        .documentation =
        \\Transforms a [vector](https://ziglang.org/documentation/0.11.0/#Vectors) into a scalar value (of type
