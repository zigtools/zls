...
pub const builtins = [_]Builtin{
    ...
    .{
        ...
        .documentation =
        \\`). For unsigned integers, the result is [undefined](https://ziglang.org/documentation/0.9.0/#undefined) if any 1 bits are shifted out. For signed integers, the result is [undefined](https://ziglang.org/documentation/0.9.0/#undefined) if any bits that disagree with the resultant sign bit are shifted out.
        \\
    ...
    .{
        ...
        \\}
        \\```
        \\`scalar` must be an [integer](https://ziglang.org/documentation/0.9.0/#Integers), [bool](https://ziglang.org/documentation/0.9.0/#Primitive-Types), [float](https://ziglang.org/documentation/0.9.0/#Floats), or [pointer](https://ziglang.org/documentation/0.9.0/#Pointers).
        ,
        .arguments = &.{
            "comptime len: u32",
            "scalar: anytype",
